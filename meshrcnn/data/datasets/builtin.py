...
SPLITS = {
    "pix3d_s1_train": ("pix3d", "pix3d/pix3D_annotations_s1_train.json"),
    "pix3d_s1_test": ("pix3d", "pix3d/pix3D_annotations_s1_test.json"),
    "pix3d_s2_train": ("pix3d", "pix3d/pix3D_annotations_s2_train.json"),
    "pix3d_s2_test": ("pix3d", "pix3d/pix3D_annotations_s2_test.json"),
}
